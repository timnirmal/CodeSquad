    ...
    return (
        <>
            ...
            <div className='flex h-screen w-full'>
                {/*<div className="flex-1 bg-[url('./backdrop.jpeg')] bg-cover bg-center bg-no-repeat">*/}
                <div className="flex-1 bg-[url('./backdropHighQ.jpg')] bg-cover bg-top bg-no-repeat">
