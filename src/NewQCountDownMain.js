import CardNewQ from './components/CardNewQ'
import React, { useEffect, useRef, useState } from 'react'
import logo from './code squad 3 logo.png'

let interval

function NewQCountDownMain() {
    ...
    useEffect(() => {
        ...
        const getTime = () => {
            const countDownDate = new Date('Dec 3, 2022 16:29:00').getTime()
...
export default NewQCountDownMain
