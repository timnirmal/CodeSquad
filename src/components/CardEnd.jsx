...
import endMusic from '../endmusic.mp3'

const CardEnd = forwardRef(({ time, prevTime, text }, ref) => {
    console.log('Card', time, prevTime)

    const audio = new Audio(endMusic)
    ...
    return (
        <div className='flex flex-col items-center gap-[1.5rem]'>
            <div
                className={`flip-card h-[1.85em] relative inline-flex flex-col text-softRed w-full min-w-[75px] sm:min-w-[100px] md:min-w-[300px] text-[1.75rem] sm:text-[3rem] md:text-[5rem] ${card_overlay}`}
                ref={ref}
            >
